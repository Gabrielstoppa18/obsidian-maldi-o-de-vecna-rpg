---
tags: [índice, moc, enciclopédia, tormenta20]
---
...
- [[Locais de Arton — Índice|🗺️ Locais e Regiões de Arton]] — 44 notas (O Reinado + Além do Reinado)
- [[Itens Mágicos — Índice|⚔️ Itens Mágicos e Artefatos]] — 99 notas (5 Artefatos, armas, armaduras, escudos, acessórios, poções/genéricos)
- [[Ameaças — Índice|☠️ Ameaças (Bestiário e Organizações)]] — ~380 criaturas do Bestiário + 8 organizações/perigos gerais

Ao todo, quase 600 notas de referência do mundo oficial de Arton.

## Fontes
- *Tormenta20 — Livro Básico (Jogo do Ano)*
- *Deuses de Arton*
- *Ameaças de Arton*
- *Heróis de Arton*
- Homebrew: *Raças Extras* (Paranta e colaboradores), *Necromante* e *Ninja* (MGraymoon)
